  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}/admin/add-announcement`,
        {
          method: "POST",
          headers: {
            ...
            {added ? (
              <>
                <h5 className="text-center text-success mt-5 pt-5">
                  The Following Announcement Was Added
                </h5>
              ...
              <>
                <h5 className="text-center text-info mt-5 pt-5">
                  Please Enter The Details Of The Announcement
                </h5>
                <form
                  onSubmit={(e) => {
                    handleSubmit(e);
